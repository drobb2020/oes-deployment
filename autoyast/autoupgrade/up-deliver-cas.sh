...
# 
#         USAGE: ./up-deliver-cas.sh <fqdn of server> 
# 
...
#  LAST UPDATED: Thu Mar 03 2016 07:54
#      REVISION: 1
#     SCRIPT ID: ---
# SSC UNIQUE ID: --
#===============================================================================
...
function helpme() {
  ...
  echo "WARNING"
  echo "------------------------------------------------------------------------"
  echo "The correct command line syntax is ./up-deliver-cas.sh <FQDN of Server>"
  echo "for example: ./up-deliver-cas.sh acpic-s2740.ross.rossdev.rcmp-grc.gc.ca"
