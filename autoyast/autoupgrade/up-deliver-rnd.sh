...
#===============================================================================
#
#          FILE: up-deliver-rnd.sh
# 
#         USAGE: ./up-deliver-rnd.sh <fqdn of server>
# 
#   DESCRIPTION: Deliver upgrade scripts to servers in CAS-RND
#
...
#       CREATED: Tue Feb 23 2016 11:18
#  LAST UPDATED: Thu Mar 03 2016 10:02
#      REVISION: 1
#     SCRIPT ID: ---
# SSC UNIQUE ID: --
#===============================================================================
...
log='/var/log/up-deliver-rnd.log'               # logging (if required)
...
function helpme() {
  ...
  echo "WARNING"
  echo "------------------------------------------------------------------------"
  echo "The correct command line syntax is ./up-deliver-rnd.sh <FQDN of Server>"
  echo "for example: ./up-deliver-rnd.sh acpic-s2007.ross.rossdev.rcmp-grc.gc.ca"
